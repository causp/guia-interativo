...
function calcularPisoCltCtpsDigital() {
    ...
    resultadoDiv.innerHTML = `
        ...
        <div>
            <h6>Para os valores informados, a remuneração mensal MÍNIMA deverá ser de </h6>
            <span class="bg-success text-white py-1 px-2 rounded">R$ ${formatarValor(valorSalarioMensalAReceber)}</span>
        </div>
    `;

    let honarios_confirmacao_clt_digital = document.getElementById('honarios_confirmacao_clt_digital');

    if (honarios_confirmacao_clt_digital) {
        honarios_confirmacao_clt_digital.style.display = 'block';
    }
