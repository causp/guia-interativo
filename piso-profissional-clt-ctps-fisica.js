...
function calcularPisoCltCtpsFisica() {
    ...
    let honarios_confirmacao_clt_fisica = document.getElementById('honarios_confirmacao_clt_fisica');

    if (honarios_confirmacao_clt_fisica) {
        honarios_confirmacao_clt_fisica.style.display = 'block';
    }
}
