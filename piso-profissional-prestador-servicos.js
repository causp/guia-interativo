...
function calcularPisoPrestador() {
    ...
    let honarios_confirmacao_prestador = document.getElementById('honarios_confirmacao_prestador');

    if (honarios_confirmacao_prestador) {
        honarios_confirmacao_prestador.style.display = 'block';
    }
}
